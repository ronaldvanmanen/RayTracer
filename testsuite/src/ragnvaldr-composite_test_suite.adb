...
with Ragnvaldr.Dimensions.Test.Suite;
with Ragnvaldr.Raytracer.Test.Suite;
with AUnit.Tests;

package body Ragnvaldr.Composite_Test_Suite is
   ...
   begin
      Result.Add_Test (Ragnvaldr.Dimensions.Test.Suite.Suite);
      Result.Add_Test (Ragnvaldr.Raytracer.Test.Suite.Suite);
      return Result;
   end Suite;
end Ragnvaldr.Composite_Test_Suite;
