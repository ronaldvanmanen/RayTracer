...
with Ada.Exceptions;
with Ragnvaldr.Numerics.Real_Vectors;

package body Ragnvaldr.Numerics.Generic_Real_Vectors.Tests is
    ...
    procedure Addition_Satisfies_Additive_Associativity (T : in out Test_Fixture) is
        ...
        A : Real_Vector := (3.0, 5.0, 7.0);
        B : Real_Vector := (13.0, 17.0, 19.0);
        C : Real_Vector := (29.0, 31.0, 37.0);
    begin
    ...
    procedure Addition_Satisfies_Additive_Commutativity (T : in out Test_Fixture) is
        pragma Unreferenced(T);
        A : Real_Vector := (13.0, 17.0, 19.0);
        B : Real_Vector := (29.0, 31.0, 37.0);
    begin
...
end Ragnvaldr.Numerics.Generic_Real_Vectors.Tests;
